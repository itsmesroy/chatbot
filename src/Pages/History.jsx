...
import ChatHistoryCard from '../components/ChatHistory';
    ...
    return (
        <Box
            ...
            sx={{
                ...
                '&::-webkit-scrollbar-track': { boxShadow: 'inset 0 0 8px rgba(0,0,0,0.1)', borderRadius: '8px' },
        ...
        >
            ...
            <Box p={{ xs: 2, md: 3 }}>
                ...
                {filteredChats.length > 0 && (
                    <Stack spacing={4} divider={<Divider sx={{ borderColor: 'primary.bg', opacity: 0.4 }} />}>
